...
use reth_revm::{database::SyncStateProviderDatabase, db::CacheDB, DatabaseRef, SyncDatabase, SyncDatabaseRef};
...
impl<'a> SyncDatabase for StateCacheDbRefMutWrapper<'a, '_> {
...
impl<'a> SyncDatabaseRef for StateCacheDbRefMutWrapper<'a, '_> {
    type Error = <StateCacheDb<'a> as SyncDatabase>::Error;
